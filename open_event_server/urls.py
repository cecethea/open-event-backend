"""open-event-server URL Configuration
...
from open_event_server.apps.user.urls import router as user_router
from open_event_server.apps.user.urls import urlpatterns as user_urls
