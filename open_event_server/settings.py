"""
Django settings for open-event-server project.
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'open_event_server',
    'open_event_server.apps.user',
    'open_event_server.apps.notification',
    'anymail',
    'simple_history',
...
ROOT_URLCONF = 'open_event_server.urls'
...
WSGI_APPLICATION = 'open_event_server.wsgi.application'
...
ACCOUNT_ADAPTER = 'open_event_server'\
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'open_event_server.apps.user.authentication.'
...
LOCAL_SETTINGS = {
    ...
    'CONTACT_EMAIL': "cecemartinthea@gmail.com",
    'EMAIL_SERVICE': False,
